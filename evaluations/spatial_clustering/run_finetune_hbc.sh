...
# Fine-tuning Script for Human Breast Cancer
...
OUTPUT_DIR="./results/spatial_clustering/st_conma/human_breast_cancer/checkpoints"
...
echo "=================================="
echo "Dataset: Human Breast Cancer"
