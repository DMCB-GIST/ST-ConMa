...
# Configuration
# =====================
OUTPUT_DIR = './results/spatial_clustering/staig/human_breast_cancer/staig_original_hpsearch'
INPUT_DIR = './ft_dataset/spatial_clustering/'
EMB_DIR = './results/spatial_clustering/staig/human_breast_cancer/resnet50_image_embeddings'
SEED = 42
